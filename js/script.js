...
$(document).ready(function(){
    $("#telefone_res").blur(function(){
        var res = /^\([1-9]{2}\)[2-5]{1}[0-9]{3}\-[0-9]{4}$/;

        if(!res.test($("#telefone_res").val())){
            if($("#telefone_res").val() == ''){
                alert("O telefone residencial é obrigatório, digite um numero de telefone residencial válido para prosseguir!");
            }else{
                alert("Telefone Inválido, insira um numero valido para prosseguir!");
            }
        }else{
...
$(document).ready(function(){
    $("#telefone_cel").blur(function(){
        var cel = /^\([1-9]{2}\)9[6-9]{1}[0-9]{3}\-[0-9]{4}$/;

        if(!cel.test($("#telefone_cel").val())){
            if($("#telefone_cel").val() == ''){
                alert("O telefone celular é obrigatório, digite um numero de celular válido para prosseguir!");
            }else{
                alert("Telefone Inválido, insira um numero valido para prosseguir!");
            }
        }else{
